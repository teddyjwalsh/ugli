...
int main()
{
    ...
    //TriangleOctree to("octree_cube.raw", "tris_cube.raw", "norms_cube.raw", "../../cube.obj", glm::vec3(0,0,0), 1.0);
    ...
    TriangleOctree to2("octree_box.raw", "tris_box.raw", "norms_box.raw", "../../wood_box.obj", glm::vec3(0), 1.0/15);// / 15.0);
    //TriangleOctree to3("octree_box.raw", "tris_box.raw", "norms_box.raw", "../../wood_box.obj", glm::vec3(0,0,-4), 1.0 / 20.0);
    auto sp = std::make_shared<StreamPreprocessor>(200,200);
